...
The project demonstrates real-world backend engineering practices, including design patterns, LLD-driven optimisations, clean layered architecture, efficient database query design, and containerized deployment using Docker & Docker-compose.
